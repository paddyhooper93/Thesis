...
title = 'BA Analysis: 3 T, no straws'; 
gnames={'Ellipsoid, Low Fe', ...
    'Ellipsoid, High Fe', 'Ellipsoid, Low Ca', 'Ellipsoid, High Ca'};
params.colors = {[1 0 1], [1 0 0], [0 1 1], [0 0 1]};

[cr1, fig1, stats1]=BlandAltman(data_neutral1, data_oblique1, Label, title, gnames, ...
    'corrInfo', corrinfo, 'baInfo', BAinfo, 'axesLimits', limits, ...
   'showFitCI', 'on', 'data1Mode', 'Compare');
hold off
saveas(gcf,fullfile(dir,'BA_NvsO_3T_noStraws.png'));

%% 7 T - > no straws
close all
data_neutral2=ref_Mean_matr(7,3:6);
data_oblique2=mean(qsm_Mean_matr(8:10,3:6),1);
title = 'BA Analysis: 7 T, no straws';
gnames={'Ellipsoid, Low Fe', ...
    'Ellipsoid, High Fe', 'Ellipsoid, Low Ca', 'Ellipsoid, High Ca'};
params.colors = {[1 0 1], [1 0 0], [0 1 1], [0 0 1]};
[cr2, fig2, stats2]=BlandAltman(data_neutral2, data_oblique2, Label, title, gnames, ...
    ...
    'showFitCI', 'on', 'data1Mode', 'Compare');
hold off
saveas(gcf,fullfile(dir,'BA_NvsO_7T_noStraws.png'));
