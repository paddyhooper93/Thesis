function [ CSF_Mask ] = extract_CSF_Modified(R2s, Mask, voxel_size, flag_erode, thresh_R2s)
% [ CSF_Mask ] = extract_CSF(R2s, Mask, voxel_size, flag_erode, thresh_R2s)
% R2s: Apply N4 and SUSAN prior to non-linear fitting for good quality R2s.
