...
prefix="7T_Neutral"
QSM_dir="./Analysis/FermiFilt_SNRwAVG_VSHARP"
...
weights="${QSM_dir}/${prefix}_weights_RR.nii.gz"
...
cluster -i "$weights" -t 5 --fractional -o "$seg" --connectivity=6 --minextent=300 --mm -r $res
