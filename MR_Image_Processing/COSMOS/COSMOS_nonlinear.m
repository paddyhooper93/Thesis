function [x_out] = COSMOS_nonlinear(Bi, Di, Wi, M, CSF_Mask, varargin)
% -----------------------
% x_out = COSMOS_nonlinear(Bi, Di, Wi, M, varargin);
% -----------------------
% Input:
...
% tol: LSQR Tolerance, 
% maxit: maximum iterations for LSQR solver
% -----------------------
% Output:
...
[tol, maxit, x0, isTik, lam_Tik, isCSF, lam_CSF] = parse_COSMOS_input(varargin{:}); 

% Mask should be logical
M = M > 0;
CSF_Mask = CSF_Mask > 0;
