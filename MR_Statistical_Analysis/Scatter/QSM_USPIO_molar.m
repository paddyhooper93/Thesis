...
uncert = 5 ./ (20:10:60).*x_usp;
x_usp_plt = (0:5:37.5) ./ 55.485;
...
x_usp_ticks = [(x_usp(1) - (x_usp(2)-x_usp(1))) x_usp];
xticks(x_usp_ticks)
xticklabels(compose("%.2f", x_usp_ticks));
...
ax.FontSize = 26;
saveas(gcf,fullfile(path_to_data,'USPIO_QSM_scatter.png'));
