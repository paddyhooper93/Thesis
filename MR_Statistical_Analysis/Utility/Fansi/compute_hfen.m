function [ hfen ] = compute_hfen( img1, img2, mask )
% Calculates the High Frequency Error metric.
%
% See README.txt for further information and references.
...
img1_log = imfilter(img1.*mask, H, 'same');

img2_log = imfilter(img2.*mask, H, 'same');
